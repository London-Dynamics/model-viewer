...
class AOPass extends Pass {
	...
	renderComposite( renderer, baseTexture, renderTarget = null, aoPrepared = false ) {

		if ( aoPrepared !== true ) {

			this.updateBeforeOutput( renderer );

		}

		this.copyMaterial.uniforms.tDiffuse.value = baseTexture;
		this.copyMaterial.blending = NoBlending;
		this.renderPass( renderer, this.copyMaterial, renderTarget );
		...
		this.renderPass( renderer, this.blendMaterial, renderTarget );
	...
	render( renderer, writeBuffer, readBuffer /*, deltaTime, maskActive */ ) {
		...
		switch ( this.output ) {
			...
			case AOPass.OUTPUT.Default:
				...
				this.renderComposite( renderer, readBuffer.texture, this.renderToScreen ? null : writeBuffer, true );
