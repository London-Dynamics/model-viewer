...
function createLinks(links, htmlName, pluralLowerCaseSubcategory, lowerCaseCategory) {
    const id = 'links'.concat(htmlName, pluralLowerCaseSubcategory, lowerCaseCategory);
...
function createEntry(entry, lowerCaseCategory, pluralLowerCaseSubcategory) {
    ...
    const links = entry.links ?
        createLinks(entry.links, entry.htmlName, pluralLowerCaseSubcategory, lowerCaseCategory) :
        '';
