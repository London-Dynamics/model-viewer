...
declare interface LDTransformsInterface {
    updateMeshPosition(name: string, position: [number, number, number]): void;
    updateMeshRotation(name: string, rotation: [number, number, number], order?: EulerOrder): void;
    ...
    updateObjectRotation(name: string, rotation: [number, number, number], order?: EulerOrder): void;
...
declare interface LDPuzzlerInterface {
...
interface CursorInterface {
    ...
    getArrowCursorPosition(): Vector3$1 | null;
    getDiscCursorPosition(): Vector3$1 | null;
...
declare const ModelViewerElementImpl: {
    ...
    new (...args: any[]): CursorInterface;
    prototype: CursorInterface;
} & {
    new (...args: any[]): LDMeasureInterface;
    prototype: LDMeasureInterface;
} & {
    new (...args: any[]): LDPuzzlerInterface;
    prototype: LDPuzzlerInterface;
} & {
    ...
    new (...args: any[]): LDTransformsInterface;
    prototype: LDTransformsInterface;
} & {
