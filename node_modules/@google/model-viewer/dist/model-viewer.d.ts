...
import { Group, Object3D, Material as Material$4, Texture as Texture$4, Vector3 as Vector3$1, Mesh as Mesh$1, WebGLRenderer, Scene as Scene$1, AnimationActionLoopStyles, PerspectiveCamera as PerspectiveCamera$1, OrthographicCamera as OrthographicCamera$1, Camera as Camera$2, Box3, Sphere, ToneMapping, Vector2, AnimationMixerEventMap, XRTargetRaySpace, EventDispatcher, Event, Intersection, MeshPhysicalMaterial, Euler, EulerOrder } from 'three';
...
declare class PlacementSession extends EventTarget {
    ...
    private _placementCursor;
    constructor(element: any, log: LogFunction, warn?: WarnFunction, error?: ErrorFunction, lowResSrc?: string, highResSrc?: string, options?: PlacementOptions);
    private _ensurePlacementCursor;
    private _disposePlacementCursor;
    hidePlacementCursor(): void;
    tickPlacementCursor(deltaMs: number): void;
...
interface FloatingControlStripInterface {
...
declare const ModelViewerElementImpl: {
    ...
    new (...args: any[]): FloatingControlStripInterface;
    prototype: FloatingControlStripInterface;
} & {
